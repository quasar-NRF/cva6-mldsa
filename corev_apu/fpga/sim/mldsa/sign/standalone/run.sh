...
#!/bin/bash
# =============================================================================
# ML-DSA-65 Sign — STANDALONE accelerator simulation
# =============================================================================
# What this tests:
#   The ML-DSA-65 accelerator (combined_top.v) in Sign mode, with NO AXI bridge.
#   The testbench drives the streaming interface directly.
#
# What gets produced:
#   Signature: 3309 bytes = 414 words
#     Layout: ctilde (6 words) || z (400 words) || h (8 words)
#
# Pass criterion:
...
if grep -q "testbench done" "$SIM_RUN_LOG"; then
    ...
    if [ "${WRONG_CNT:-0}" -eq 0 ]; then
        echo "==========================================================="
        echo " RESULT: PASS — Sign signature matches KAT byte-for-byte"
        echo "==========================================================="
        exit 0
    else
        echo "==========================================================="
