...
echo "==================================================================="
echo " ML-DSA Verify BRIDGE sim (sec_lvl=${SEC_LVL} / ML-DSA-${KAT_SUF}, AXI BFM + axi_mldsa_bridge)"
echo "==================================================================="
...
# TUMCREATE: BRG_DEBUG=1 env var enables bridge FIFO visibility.
BRG_DBG_FLAGS=""
if [ "${BRG_DEBUG:-0}" = "1" ]; then
    BRG_DBG_FLAGS="-d BRG_DEBUG"
    echo "  BRG_DEBUG=1 enabled" | tee -a "$LOG"
fi
